...
new.data1 <- knnExtract(xtr = as.matrix(dtrain), ytr = as.factor(y[tri2]), xte = as.matrix(dval), k = 100)
new.data2 <- knnExtract(xtr = as.matrix(dtrain), ytr = as.factor(y[tri2]), xte = as.matrix(dtest[-tri, ]), k = 100)
